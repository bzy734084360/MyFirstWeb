...
namespace Bzy.Utilities
{
    public class HttpHelper
    {
        ...
        public HttpResult GetHtml(HttpItem item)
        {
            ...
            try
            {
                ...
                using (response = (HttpWebResponse)request.GetResponse())
                {
                    ...
                    {
                        //是否返回Byte类型数据
                        if (item.WebResultType == WebResultType.Byte) result.ResultByte = ResponseByte;
                        //从这里开始我们要无视编码了
                        if (encoding == null)
                        {
        ...
        public static string HttpPostForm(string url, IDictionary<string, object> param, IDictionary<object, string> headers = null, string method = "POST")
        {
            ...
            if (param != null)
            {
                foreach (var p in param)
                {
                    ...
                    //if (p.Value is string || p.Value is int)
                    postString.AppendFormat("{0}={1}", p.Key, p.Value);
                }
            }

            string urlEncoded = Uri.EscapeUriString(postString.ToString());
            ...
            //byte[] postBytes = utf8.GetBytes(urlEncoded);
    ...
    public class HttpItem
    {
        ...
        private WebResultType resulttype = WebResultType.String;
        /// <summary>
        /// 设置返回类型String和Byte
        /// </summary>
        public WebResultType WebResultType
        {
    ...
    public class HttpResult
    {
        ...
        public CookieCollection CookieCollection { get; set; }
        /// <summary>
        /// 返回的String类型数据 只有WebResultType.String时才返回数据，其它情况为空
        /// </summary>
        public string Html { get; set; }
        /// <summary>
        /// 返回的Byte数组 只有WebResultType.Byte时才返回数据，其它情况为空
        /// </summary>
